...
INSERT INTO "subscription_plans" ("name", "slug", "price_monthly", "price_yearly", "features", "max_active_deals", "max_total_deals", "monthly_lead_unlocks", "sponsorship_types", "is_active", "sort_order")
VALUES
  (
    'Free', 'free', 0, 0,
...
SELECT 'Subscription plans seeded: ' || count(*) FROM subscription_plans;
