...
export class SubscriptionPlan {
  ...
  @Column({ name: 'razorpay_plan_id_monthly', type: 'varchar', length: 255, nullable: true })
  razorpayPlanIdMonthly: string | null;

  @Column({ name: 'razorpay_plan_id_yearly', type: 'varchar', length: 255, nullable: true })
  razorpayPlanIdYearly: string | null;

  @Column({ name: 'apple_product_id_monthly', type: 'varchar', length: 255, nullable: true })
  appleProductIdMonthly: string | null;

  @Column({ name: 'apple_product_id_yearly', type: 'varchar', length: 255, nullable: true })
